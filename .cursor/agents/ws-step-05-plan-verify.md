---
name: ws-step-05-plan-verify
description: "Workflow step agent 05. Internal orchestrator dispatch only; do NOT invoke autonomously."
disable-model-invocation: true
---

<!-- @generated by workflow-skills compile_host_subagents.cjs. DO NOT EDIT DIRECTLY. hash:f1cfb20a6d912954030a3edb248815b4edc013bbaa970375aac98070ac3e3aae -->

# Specialized Subagent — Step 05 (plan-verify)

> Compiled from canonical skill: `.agents/skills/ws-plan-verify/SKILL.md`
...
**Canonical output:** `{us-dir}/step-05-{slug}.plan.report.md`. Optional Quick Score report shape: [`TEMPLATE.md`](../../.agents/skills/ws-plan-verify/TEMPLATE.md).
...
2. **Evaluate**: Inspect code and tests using tools. Quick Score evaluates Completeness, Correctness & Style, and Testing. US Verification maps every plan feature and acceptance criterion to **Implemented**, **Not implemented**, or **Implemented differently**, each with file:line evidence. Also map spec **negative test** scenarios (`negativeScenarios` from Validation Notes / failing cases) to covering tests before advancing; missing negative coverage is a gap, not an implicit pass.
   ...
   - Optional `fable` integration: If `config.json.fable.enabled` and `autoAudit` are `true`, run [`ws-fable-judge`](../../.agents/skills/ws-fable-judge/SKILL.md) against `git diff` ground truth. Record verdict (`VERIFIED`, `VERIFIED WITH CAVEATS`, `REFUTED`) and fraud findings in the report.
...
4. **Write report**: save `{us-dir}/step-05-{slug}.plan.report.md` using [`TEMPLATE.md`](../../.agents/skills/ws-plan-verify/TEMPLATE.md) shape (frontmatter: `us`, `reportDate`, `score`, `sourcePlans`, `evalSource`; body sections Result by Feature, Additional Features, Stack Invariant Compliance, Gaps and Next Steps). Do not edit the reference plan/spec files.
